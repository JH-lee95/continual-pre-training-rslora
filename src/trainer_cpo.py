...
def main(args):
    ...
    train_dataset=load_and_prepare_dataset_cpo(tokenizer=tokenizer,
                                        seed=args.seed,
                                        max_len=args.max_len,
                                        translation_template_wo_term_dict=TranslationTemplate.template_wo_term_dict,
                                        translation_template_w_term_dict=TranslationTemplate.template_w_term_dict,
