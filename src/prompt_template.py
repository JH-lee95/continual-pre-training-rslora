...
class TranslationTemplate:
    translation_template_w_glossary='''You are a professional translator. Translate the following {} source texts into {}. Refer to the word pairs in the glossary when you translate. Do not translate the glossary itself. Consider the context among the source texts carefully.
{}
Translation:
'''

    translation_template_wo_glossary='''You are a professional translator. Translate the following {} source texts into {}. Consider the context among the source texts carefully.
{}
Translation:
'''
