...
torchrun --nproc-per-node 4  src/run_training.py --base_model_dir beomi/Yi-Ko-34B --train_batch_size 1 --expr_desc "finetuning" --expr_name "Term-MT" --run_name "yi-ko-34b-stage1-sharegpt8k" --max_seq_length 4096 --learning_rate 1e-5 --train_dataset_dir /nvme0/data/training_dataset_sharegpt_8k --enable_lora --cache_dir /nvme0/models --gradient_checkpointing --lora_rank 8 --lora_alpha 8
