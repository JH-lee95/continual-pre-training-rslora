...
python src/run_training.py --base_model_dir maywell/Yi-Ko-34B-Instruct --train_batch_size 1 --expr_desc "finetuning" --expr_name "Term-MT" --run_name "yi-ko-34b-inst-data1.1k" --max_seq_length 4096 --learning_rate 1e-5 --train_dataset_dir /nvme0/data/training_dataset_1.1k_refined --enable_lora --cache_dir /nvme0/models --device_map "auto"
