...
torchrun --nproc-per-node 4  src/run_training.py --base_model_dir maywell/EEVE-Korean-Instruct-10.8B-v1.0-32k --train_batch_size 1 --expr_desc "finetuning" --expr_name "Term-MT" --run_name "eeve-inst32k-data2k_neft" --max_seq_length 8192 --learning_rate 1e-5 --train_dataset_dir /nvme0/data/training_dataset_2k --enable_lora --cache_dir /nvme0/models --gradient_checkpointing
