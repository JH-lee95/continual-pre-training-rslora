...
torchrun --nproc-per-node 4 src/trainer_cpo.py --base_model_dir /root/azurestorage/models/production/tmt-17k --batch_size 1 --epoch_size 1 --expr_desc finetuning --expr_name tmt-cpo-9k --gradient_accumulation_steps 4 --max_len 2048 --learning_rate 5e-5 --gradient_checkpointing True
