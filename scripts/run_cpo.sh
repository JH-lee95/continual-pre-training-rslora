...
torchrun --nproc-per-node 4 src/trainer_cpo.py --base_model_dir /root/azurestorage/models/production/tmt-wsg --batch_size 4 --epoch_size 1 --expr_desc finetuning --expr_name tmt-cpo --gradient_accumulation_steps 2 --max_len 4096 --learning_rate 5e-6 --gradient_checkpointing True
