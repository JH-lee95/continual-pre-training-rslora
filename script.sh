...
torchrun --nproc-per-node 4 src/trainer_sft.py --base_model_dir beomi/OPEN-SOLAR-KO-10.7B --batch_size 1 --epoch_size 1 --expr_desc finetuning --expr_name tmt-kosolar --gradient_accumulation_steps 16 --max_len 4096
